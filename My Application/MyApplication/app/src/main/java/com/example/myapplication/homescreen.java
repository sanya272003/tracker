...
public class homescreen extends AppCompatActivity {
    ...
    private void loginDetails() {
        ...
        {
            Intent intent=new Intent(homescreen.this,firsthomepage.class);
        ...
        remember.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(buttonView.isChecked())
                {
                    ...
                    editor.apply();
                    Toast.makeText(homescreen.this,"Remember me Checked..",Toast.LENGTH_SHORT).show();
                }
                else if(!buttonView.isChecked())
                {
                    ...
                    editor.apply();
                    Toast.makeText(homescreen.this,"Remember me Unchecked..",Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void checkEmailVerification()
    {
        ...
        if(emailflag)
        {
            ...
            startActivity(new Intent(homescreen.this,firsthomepage.class));
        }
        else
        {
